...
const (
	AnalyticsService_PublishEvent_FullMethodName = "/analytics.AnalyticsService/PublishEvent"
)
...
func (c *analyticsServiceClient) PublishEvent(ctx context.Context, in *PublishEventRequest, opts ...grpc.CallOption) (*PublishEventResponse, error) {
	out := new(PublishEventResponse)
	err := c.cc.Invoke(ctx, AnalyticsService_PublishEvent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAnalyticsServiceServer) PublishEvent(context.Context, *PublishEventRequest) (*PublishEventResponse, error) {
...
func _AnalyticsService_PublishEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PublishEventRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalyticsServiceServer).PublishEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AnalyticsService_PublishEvent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticsServiceServer).PublishEvent(ctx, req.(*PublishEventRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _AnalyticsService_PublishEvent_Handler,
		},
	},
